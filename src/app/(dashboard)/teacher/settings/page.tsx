            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input type="email" {...register('email')} className="rounded-xl border-[#E8ECF4] focus:border-[#1E88E5] focus:ring-[#1E88E5]/10" />
                </div>
              </div>
              <div className="space-y-1.5">
                ...
                <p className="text-[12px] text-[#9CA3AF]">Contact your admin to change institution details.</p>
              </div>
              <div className="flex items-center justify-between pt-2">
                ...
                <Button type="submit" size="sm" className="gap-1.5 rounded-xl bg-[#1E88E5] hover:bg-[#1976D2]">
          ...
          <div className="rounded-2xl border border-[#EBF0F8] bg-white shadow-[0_2px_8px_rgba(0,0,0,0.05)] overflow-hidden">
            ...
            <div className="px-5 pb-5">
              ...
              <div className="mt-4 grid grid-cols-3 gap-2 rounded-xl bg-[#F4F7FC] p-3">
                {[
                  { label: 'Exams',    value: '8',   icon: FileText,      color: '#1E88E5' },
                  { label: 'Students', value: '142', icon: GraduationCap, color: '#7C3AED' },
                  { label: 'Avg Trust', value: '91', icon: ShieldCheck,   color: '#16A34A' },
                ].map(s => {
                  const Icon = s.icon;
                  return (
