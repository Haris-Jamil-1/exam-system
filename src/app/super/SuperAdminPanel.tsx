...
// Only ever rendered by page.tsx once its own server-side isSuperAdmin check has
// already passed — the 403 handling below is defense-in-depth (matches this
// codebase's convention of not relying on a single enforcement layer), not the
// primary gate.
